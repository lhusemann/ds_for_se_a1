...
#SBATCH --job-name="dssecs-group-9-hlouis-granite-zero-shot-arc"
...
#SBATCH --output=/scratch/hpc-prf-dssecs/group-9/logs/mistral_output_%j.log
#SBATCH --error=/scratch/hpc-prf-dssecs/group-9/logs/mistral_error_%j.log
...
source /scratch/hpc-prf-dssecs/group-9/venv/bin/activate
...
export HF_HOME=/scratch/hpc-prf-dssecs/group-9/huggingface_cache
...
python hierachical_summarization.py arc zero-shot
